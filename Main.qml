...
MainView {
    ...
    Page {
        ...
        Grid {
            ...
            Rectangle {
                color: open.contents.stages[check.phase].lvl[0]
            ...
            Rectangle {
                color: open.contents.stages[check.phase].lvl[1]
            ...
            Rectangle {
                color: open.contents.stages[check.phase].lvl[2]
                width: parent.width/4
                height: parent.height/3
                Behavior on color {
                    ColorAnimation {
            ...
            //middle row
            Rectangle {
                color: open.contents.stages[check.phase].lvl[3]
                width: parent.width/4
                height: parent.height/3
                Behavior on color {
                    ColorAnimation {
            ...
            Rectangle {
                color: open.contents.stages[check.phase].lvl[4]
                width: parent.width/2
                height: parent.height/3
                Icon{
            ...
            Rectangle {
                color: open.contents.stages[check.phase].lvl[5]
                width: parent.width/4
                height: parent.height/3
                Behavior on color {
                    ColorAnimation {
            ...
            //bottom row
            Rectangle {
                color: open.contents.stages[check.phase].lvl[6]
                width: parent.width/4
                height: parent.height/3
                Behavior on color {
                    ColorAnimation {
            ...
            Rectangle {
                color: open.contents.stages[check.phase].lvl[7]
                width: parent.width/2
                height: parent.height/3
                Behavior on color {
                    ColorAnimation {
            ...
            Rectangle {
                color: open.contents.stages[check.phase].lvl[8]
                width: parent.width/4
                height: parent.height/3
                Behavior on color {
                    ColorAnimation {
